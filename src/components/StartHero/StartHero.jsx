...
const StartHero = (props) => {
    return (
        <div className="relative overflow-hidden bg-slate-950 text-white">
            ...
            {/* Hero Main Panel */}
            <div className="relative min-h-[500px] md:min-h-[560px] flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `linear-gradient(rgba(15, 23, 42, 0.78), rgba(15, 23, 42, 0.88)), url(${home_carousel1})` }}>
                <div className="container mx-auto px-6 py-16 text-center z-10 flex flex-col items-center">
                    <span className="bg-[#a21d2e] text-white text-xs font-bold uppercase px-3 py-1.5 rounded-full tracking-widest mb-6 animate-pulse shadow-lg">
                        Initiated By Medi-Caps University
                    </span>
                    ...
                    <div className="flex flex-wrap justify-center gap-4 mt-8">
                        <Link to={ROUTES.REGISTER} className="click-scale">
                          <button className="conf-btn-primary py-2.5 px-6 text-xs sm:text-sm tracking-wider uppercase font-semibold">
                            Register Now
                          </button>
                        </Link>
                        <Link to={ROUTES.PAPER_SUBMISSION} className="click-scale">
                          <button className="conf-btn-secondary py-2.5 px-6 text-xs sm:text-sm tracking-wider uppercase font-semibold">
                            Submit Paper
                          </button>
                        </Link>
                        <a href={assets.brochurePDF} download="conferenceBrochure" target="_blank" rel="noopener noreferrer" className="click-scale">
                          <button className="conf-btn-accent py-2.5 px-6 text-xs sm:text-sm tracking-wider uppercase font-semibold flex items-center gap-2">
